...
// 设置商品详细信息
export const SET_GOODS_SPECS = (state, data) => {
  state.goodsSpecs = data;
};
// 设置商品详细信息
export const SET_GOODS_COLOUR = (state, data) => {
  state.goodsColour = data;
};
// 设置商品详细信息
export const SET_GOODS_INFO_ID = (state, data) => {
  state.goodsInfoById = data;
};
...
// 支付消息
export const PAY_RESPONSE = (state, data) => {
  state.payResponse = data ;
};

// 我的订单
export const SET_USER_ORDER_LIST = (state, data) => {
