      ...
      <div class="nav-side" ref="navSide">
        <ul>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <router-link :to="{path:'/goodsList',query:{category:'家用电器',page:1}}">
            <span class="nav-side-item">家用电器</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <router-link :to="{path:'/goodsList',query:{category:'手机',page:1}}">
            <span class="nav-side-item">手机</span> 
            </router-link>
            /
             <router-link :to="{path:'/goodsList',query:{category:'运营商',page:1}}">
            <span class="nav-side-item">运营商</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'数码',page:1}}">
            <span class="nav-side-item">数码</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <router-link :to="{path:'/goodsList',query:{category:'电脑',page:1}}">
            <span class="nav-side-item">电脑</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'办公',page:1}}">
            <span class="nav-side-item">办公</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <router-link :to="{path:'/goodsList',query:{category:'家居',page:1}}">
            <span class="nav-side-item">家居</span>
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'家具',page:1}}">
            <span class="nav-side-item">家具</span>
            </router-link>
             /
            <router-link :to="{path:'/goodsList',query:{category:'家装',page:1}}">
            <span class="nav-side-item">家装</span>
            </router-link>
             /
             <router-link :to="{path:'/goodsList',query:{category:'厨具',page:1}}">
            <span class="nav-side-item">厨具</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
              <router-link :to="{path:'/goodsList',query:{category:'男装',page:1}}">
            <span class="nav-side-item">男装</span>
            </router-link>
             /
            <router-link :to="{path:'/goodsList',query:{category:'女装',page:1}}">
            <span class="nav-side-item">女装</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'童装',page:1}}">
            <span class="nav-side-item">童装</span>
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'内衣',page:1}}">
            <span class="nav-side-item">内衣</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <router-link :to="{path:'/goodsList',query:{category:'美妆个护',page:1}}">
            <span class="nav-side-item">美妆个护</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'宠物',page:1}}">
            <span class="nav-side-item">宠物</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
              <router-link :to="{path:'/goodsList',query:{category:'女鞋',page:1}}">
            <span class="nav-side-item">女鞋</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'箱包',page:1}}">
            <span class="nav-side-item">箱包</span>
            </router-link>
             /
             <router-link :to="{path:'/goodsList',query:{category:'钟表',page:1}}">
            <span class="nav-side-item">钟表</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'珠宝',page:1}}">
            <span class="nav-side-item">珠宝</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
              <router-link :to="{path:'/goodsList',query:{category:'男鞋',page:1}}">
            <span class="nav-side-item">男鞋</span>
            </router-link>
             /
             <router-link :to="{path:'/goodsList',query:{category:'运动',page:1}}">
            <span class="nav-side-item">运动</span>
            </router-link>
             /
             <router-link :to="{path:'/goodsList',query:{category:'户外',page:1}}">
            <span class="nav-side-item">户外</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <router-link :to="{path:'/goodsList',query:{category:'汽车',page:1}}">
            <span class="nav-side-item">汽车</span>
            </router-link>
             /
            <router-link :to="{path:'/goodsList',query:{category:'汽车用品',page:1}}">
            <span class="nav-side-item">汽车用品</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
              <router-link :to="{path:'/goodsList',query:{category:'母婴',page:1}}">
            <span class="nav-side-item">母婴</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'玩具乐器',page:1}}">
            <span class="nav-side-item">玩具乐器</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <router-link :to="{path:'/goodsList',query:{category:'食品',page:1}}">
            <span class="nav-side-item">食品</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'酒类',page:1}}">
            <span class="nav-side-item">酒类</span>
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'生鲜',page:1}}">
            <span class="nav-side-item">生鲜</span>
            </router-link>
             /
             <router-link :to="{path:'/goodsList',query:{category:'特产',page:1}}">
            <span class="nav-side-item">特产</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <router-link :to="{path:'/goodsList',query:{category:'礼品鲜花',page:1}}">
            <span class="nav-side-item">礼品鲜花</span>
            </router-link>
             /
             <router-link :to="{path:'/goodsList',query:{category:'农资绿植',page:1}}">
            <span class="nav-side-item">农资绿植</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(1)" @mouseleave="hideDetail(1)">
            <router-link :to="{path:'/goodsList',query:{category:'医药保健',page:1}}">
            <span class="nav-side-item">医药保健</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'计生情趣',page:1}}">
            <span class="nav-side-item">计生情趣</span>
            </router-link>
          </li>
          <li @mouseenter="showDetail(2)" @mouseleave="hideDetail(2)">
            <router-link :to="{path:'/goodsList',query:{category:'图书',page:1}}">
            <span class="nav-side-item">图书</span> 
            </router-link>
            /
            <router-link :to="{path:'/goodsList',query:{category:'音像',page:1}}">
            <span class="nav-side-item">音像</span>
            </router-link>

             /
             <router-link :to="{path:'/goodsList',query:{category:'电子书',page:1}}">
      ...
      <div class="nav-content">
          ...
          <Carousel autoplay loop>
              <CarouselItem  v-for="(item, index) in marketing.CarouselItems" :key="index">
                <router-link :to="item.url">
                  <img :src="item.pic" style="width: 792px;height:350px">
                </router-link>
              </CarouselItem>
          </Carousel>
        </div>
        <div class="nav-show">
          <div class="nav-show-img" v-for="(item, index) in marketing.activity" :key="index">
            <router-link :to="{path:'/goodsList',query:{category:item.category,page:1}}" >
              <img :src="item.img">
            </router-link>
          </div>
        </div>
