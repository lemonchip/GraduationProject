<template>
  <div class="box">
    <div class="nav">
      ...
      <ul class="detail">
        <li class="first" v-show="!userInfo.user.closername">
        ...
        <li v-show="!!userInfo.user.closername">
          <Dropdown>
            <p class="username-p">
              <Avatar class="person-icon" icon="person" size="small" :src="userInfo.user.avatar"/> <span class="username">{{userInfo.user.closername}} </span>
            </p>
            <DropdownMenu slot="list">
                <div class="my-page">
