...
export default {
  ...
  created () {
    this.loadGoodsInfo();
    this.productID = this.$route.query.productID;//获取上个页面传递的productID,在下面获取数据的时候先提交productID
      const data = {
        productID:this.productID
      }
     this.loadGoodsInfoById(data) ;
  },
  data () {
    return {
  ...
  methods: {
    ...mapActions(['loadGoodsInfo','loadGoodsInfoById'])
  },
  computed: {
