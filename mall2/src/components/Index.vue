        ...
        <div class="seckill-content">
          <div class="seckill-item" v-for="(item, index) in seckills.goodsList" :key="index">
            <div class="seckill-item-img">
              <router-link to="/goodsList"><img :src="item.pic"></router-link>
            </div>
            <div class="seckill-item-info">
              <p>{{item.name}}</p>
              <p>
                <span class="seckill-price text-danger"><Icon type="social-yen"></Icon>{{item.flashPromotionPrice}}</span>
...
export default {
  ...
  methods: {
    ...mapActions(['loadSeckillsInfoReq', 'loadCarouselItems', 'loadComputer', 'loadEat', 'loadShoppingCart']),
